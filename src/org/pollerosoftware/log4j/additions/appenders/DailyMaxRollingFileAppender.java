...
import org.pollerosoftware.log4j.rolling.helper.RollingCalendar;

/**
 * DailyMaxRollingFileAppender extends {@link LazyFileAppender} so that the
 ...
 */
public class DailyMaxRollingFileAppender extends LazyFileAppender {
	 ...
	 * renamed to the value of the scheduledFilename variable when the next interval
	 * is entered.
	 */
	 ...
	 * 
	 * @return integer representing of one of the constants: TOP_OF_TROUBLE, TOP_OF_MINUTE, HALF_DAY, TOP_OF_DAY, TOP_OF_WEEK, TOP_OF_MONTH
	 */
	 ...
	 * periodicity type and the current time, it computes the past maxBackupIndex date.
	 * 
	 * @author Alessio Pollero
	 * @version 1.0
	 */
	static final class RollingPastCalendar extends RollingCalendar {

		private static final long serialVersionUID = -5358188841736958608L;
		...
		public Date getPastDate(Date now, int maxBackupIndex) {
			...
			switch (type) {
			case 0: // DailyRollingFileAppender.TOP_OF_MINUTE
			...
			case 1: // DailyRollingFileAppender.TOP_OF_HOUR
			...
			case 2: // DailyRollingFileAppender.HALF_DAY
				this.set(Calendar.MINUTE, this.get(Calendar.MINUTE));
				this.set(Calendar.SECOND, this.get(Calendar.SECOND));
				this.set(Calendar.MILLISECOND, this.get(Calendar.MILLISECOND));
			...
			case 3: // DailyRollingFileAppender.TOP_OF_DAY
			...
			case 4: // DailyRollingFileAppender.TOP_OF_WEEK
			...
			case 5: // DailyRollingFileAppender.TOP_OF_MONTH
